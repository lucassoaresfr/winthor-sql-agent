...
export function Composer({ onSend, isStreaming, disabled }: ComposerProps) {
  ...
  return (
    <div
      className={cn(
        "w-full max-w-2xl mx-auto z-10 px-2 sm:px-4",
        hasAnimated && "composer-intro",
      )}
    >
      <div
        className={cn(
          "flex flex-col gap-3 p-3 sm:p-4 bg-white border-stone-200 transition-all duration-200 overflow-hidden relative rounded-3xl",
      ...
      >
        <div className="flex gap-2 items-center">
          <textarea
            ...
            className={cn(
              ...
              "max-h-36 sm:max-h-48 overflow-y-auto",
            )}
        ...
        <div className="flex items-center gap-2 px-1 pt-0.5">
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-zinc-100 text-stone-600">
            <Brain size={15} />
